...
def update_gui():
    ...
    global last_frame1, last_frame2, _cam2_visible
...
# ============= JOYSTICK DENTRO DE LA VISTA DE LA CÁMARA 1 =============
# El joystick va superpuesto en la esquina de la ventana donde se ve la cámara.
JOY_SIZE = 150
joy_canvas = tk.Canvas(cam1_frame, width=JOY_SIZE, height=JOY_SIZE,
                       bg=secondary_color, highlightthickness=1,
                       highlightbackground=accent_color)
joy_canvas.place(relx=1.0, rely=1.0, anchor="se", x=-8, y=-8)

move_status_label = tk.Label(cam1_frame,
                             text="Dir: —",
                             font=("Arial", 9, "bold"),
                             bg=secondary_color,
                             fg=accent_color)
move_status_label.place(relx=0.0, rely=1.0, anchor="sw", x=6, y=-6)
...
_joy_stick = joy_canvas.create_oval(_joy_cx - _joy_stick_r, _joy_cy - _joy_stick_r,
                                    ...
                                    fill="#ff3b3b", outline="")
_joy_font = ("Arial", 9, "bold")
joy_canvas.create_text(_joy_cx, _joy_cy - _joy_base_r - 9, text="W", font=_joy_font, fill="#888888")
joy_canvas.create_text(_joy_cx, _joy_cy + _joy_base_r + 9, text="S", font=_joy_font, fill="#888888")
joy_canvas.create_text(_joy_cx - _joy_base_r - 10, _joy_cy, text="A", font=_joy_font, fill="#888888")
joy_canvas.create_text(_joy_cx + _joy_base_r + 10, _joy_cy, text="D", font=_joy_font, fill="#888888")
...
def _joy_update_outputs():
    ...
    try:
        move_status_label.config(text=f"Dir: {txt}")
    except Exception:
        pass
