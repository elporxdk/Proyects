...
| `qr` | Menú → Código QR codifica la web de este ESP32 y, en la otra página, la dirección de MEDIBOT; y la **guarda de 32 bytes** rechaza lo que no cabe en vez de generar un código que se lee mal |
